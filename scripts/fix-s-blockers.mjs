...
const heroNew = `      <div class="expo-hero__copy">
        ...
        <div class="expo-install-cmd expo-hero__install" aria-label="Install command">
          <code>npm i @birdapi/velinstyle@1.2.2</code>
          <button type="button" class="velin-btn velin-btn--primary velin-btn--sm" data-copy="npm i @birdapi/velinstyle@1.2.2">Copy</button>
        </div>
        <div class="expo-hero__actions">
