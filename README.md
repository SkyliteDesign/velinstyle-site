...
Marketing website and extended documentation for **[VelinStyle](https://github.com/SkyliteDesign/velinstyle)** (accessibility-first CSS framework, **v0.7.0** — WCAG 2.2 AA).
...
- **npm/CDN:** document **`@birdapi/velinstyle@0.7.0`** (`npm install @birdapi/velinstyle`, jsDelivr/unpkg under `@birdapi/velinstyle`). Local demos use `dist/` copied from the framework repo. Bulk-update: `python tools/sync-0.7.0.py` (dist + versions) or `python tools/patch-install-paths.py`.
