...
| `.velin-filter-check:checked` | `background: var(--velin-color-primary); color: var(--velin-color-on-primary, #fff); border-color: var(--velin-color-pri…` |
| `.velin-filter-check:focus-visible` | `outline: 3px solid var(--velin-color-focus); outline-offset: 2px;` |
...
| `.velin-filter-group:has` | `display: none;` |
